...
export const toolCategories: ToolCategory[] = [
  ...
  },
  {
    ...
    subTools: [
      ...
      { id: "mdc", title: "MDC Encryption", description: "Modification Detection Code - Ensures data integrity" },
      { id: "urlEncode", title: "URL Encode", description: "Converts special characters to URL-safe format" },
      { id: "urlDecode", title: "URL Decode", description: "Decodes URL-encoded strings back to original format" },
      { id: "htmlEncode", title: "HTML Encode", description: "Converts special characters to HTML entities" },
      { id: "htmlDecode", title: "HTML Decode", description: "Converts HTML entities back to special characters" },
